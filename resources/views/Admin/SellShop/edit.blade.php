                ...
                <form id="data">
                    <ul class="ulColumn2">
                        ...
                        <li style=" display:none" class="time_handle">
                            ...
                            <input type="text" class="textbox" id="start_time" value="{{$shop_list->start_time}}" name="start_time"  placeholder="请输入活动开始时间..." />
                        </li>

                        <li style=" display:none" class="time_handle">
                            <span class="item_name" style="width:120px;">结束时间：</span>
                            <input type="text" class="textbox" id="end_time" value="{{$shop_list->end_time}}" name="end_time"  placeholder="请输入活动结束时间..." />
                        </li>
